...
function deepDup(arr, deepCopy = []) {
  if (arr.length === deepCopy.length) {
    console.log(deepCopy)
    return deepCopy
  }
  let lastEl = JSON.parse(JSON.stringify(arr[deepCopy.length]))
  deepCopy.push(lastEl)
  return deepDup(arr, deepCopy)
}
